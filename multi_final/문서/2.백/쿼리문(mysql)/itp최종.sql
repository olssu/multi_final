...
insert itp_member values ("abc", "abc@naver.com", "abc12345!", default, default);
insert itp_member values ("abcd", "abcd@naver.com", "abcD12345!", default, default);

select * from itp_member;

commit;

delete from itp_member where m_name='abc';

update itp_member set m_role=0 where m_name='manager';
UPDATE itp_member SET m_name="cdf", m_passwd="cdf123123A!" WHERE m_email="abc@naver.com";
UPDATE itp_member SET m_passwd="abc123132B!" WHERE m_name="abc";
...
delete from itp_com where c_no=9;
